...
```
As entidades, são: empresa, produto, encomenda, fornecedor e armazém.

Um produto tem os seguintes atributos: código, nome, preço e taxa de IVA.
Uma encomenda tem os atributos de: número de encomenda, a data em que foi realizada e um único fornecedor.
Um fornecedor tem os atributos: nome, número de informação fiscal, endereço, número de fax, condições de pagamento (pronto, 30 dias ou 60 dias) e um código interno.
O armazém tem o atibuto: número de produtos.

Existe relações entre a empresa e os produtos que esta vende, o armazém e a quantidade de produtos que este armazena, uma encomenda e a quantia de produtos que esta tem, o fornecedor fornece produto.
...
```
Empresa - produto: Tem uma relação Binário, 1 empresa para n produtos e obrigatória da parte do produto e parcial da empresa.
Armazem - produto: Tem uma relação Binária, N armazéns para M produtos e parcial do armazém e do produto.
Encomenda - Produto: Tem uma relação Binário, N encomenda para M produtos e parcial do produto e da ecomenda.
Fornecedor - Produto: Tem uma relação Binário, N fornecefor para N produtos e parcial do produto e total do fornecedor.
...
![ex_2_1!](/imagens/2_1.png "AnImage or PDF file")
...
![ex_2_2!](/imagens/BD_2.drawio.png "AnImage or PDF file")
...
![ex_2_3!](/imagens/ex2_3.drawio.png "AnImage or PDF file")
...
![ex_2_4a!](/imagens/ex2_4.drawio.png "AnImage or PDF file")
