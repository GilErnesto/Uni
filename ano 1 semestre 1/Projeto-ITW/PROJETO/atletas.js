...
var vm = function () {
    ...
    self.activate = function (id) {
        ...
        ajaxHelper(composedUri, 'GET').done(function (data) {
            ...
            console.error("Error fetching athletes: ", textStatus, errorThrown);
            console.error("Response: ", jqXHR.responseText);
        });
    };

    self.searchAthletes = function (searchTerm, order) {
...
$(document).ready(function () {
    ...
    $("#searchButton").click(function () {
        ...
        if (searchTerm) {
            viewModel.searchAthletes(searchTerm, order);
        }
    });
    ...
    $("#clearButton").click(function () {
        ...
        viewModel.order('');
        viewModel.activate(1); // Recarrega a lista de atletas sem filtro de pesquisa
    });
});
