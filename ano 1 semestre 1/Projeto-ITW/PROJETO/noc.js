$(document).ready(function () {
    function ViewModel() {
        ...
        self.displayName = ko.observable('Lista de Comitivas');
        ...
        self.activate = function (id) {
            ...
            ajaxHelper(composedUri, 'GET').done(function (data) {
                ...
                console.error("Error fetching NOCs: ", textStatus, errorThrown);
                console.error("Response: ", jqXHR.responseText);
            });
        };

        self.searchNOCs = function () {
            console.log('CALL: searchNOCs...');
        ...
        self.clearFilter = function () {
            self.searchTerm('');
            self.order('');
            self.activate(1); // Recarrega a lista de NOCs sem filtro de pesquisa
        };
    ...
    $("#searchButton").click(function () {
        ...
        if (searchTerm) {
            viewModel.searchNOCs(searchTerm, order);
        }
    });
    ...
    $("#clearButton").click(function () {
        ...
        viewModel.order('');
        viewModel.activate(1); // Recarrega a lista de NOCs sem filtro de pesquisa
    });
});